package com.zcloud.space.gateway.filter;
...
import com.zcloud.space.common.core.util.WebUtils;
import com.zcloud.space.gateway.config.FilterIgnorePropertiesConfig;
			...
			try {
				...
				try {
					return response.writeWith(Mono.just(response.bufferFactory()
							.wrap(objectMapper.writeValueAsBytes(new R().error(e.getMessage())))));
